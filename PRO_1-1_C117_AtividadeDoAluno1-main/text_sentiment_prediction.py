...
train_data = pd.read_csv("C:/Users/juizp/OneDrive/Área de Trabalho/Byju's/PRO_1-1_C117_AtividadeDoAluno1-main/static/data_files/tweet_emotions.csv")    
training_sentences = []
...
#carregue o modelo
model = load_model("C:/Users/juizp/OneDrive/Área de Trabalho/Byju's/PRO_1-1_C117_AtividadeDoAluno1-main/static/model_files/Tweet_Emotion.h5")
...
def predict(text):
    ...
    if text!="":
        ...
        padded = pad_sequences(sequences,maxlen=max_length,padding=padding_type,truncatimg=trunc_type)
